...
/* First created by JCasGen Tue Sep 22 14:20:21 EDT 2015 */
package type;
...
/** 
 * Updated by JCasGen Tue Sep 22 14:20:21 EDT 2015
 * @generated */
public class SourceDocumentInformation_Type extends Annotation_Type {
  ...
  public String getUri(int addr) {
      ...
      jcas.throwFeatMissing("uri", "type.SourceDocumentInformation");
  ...
  public int getOffsetInSource(int addr) {
      ...
      jcas.throwFeatMissing("offsetInSource", "type.SourceDocumentInformation");
  ...
  public boolean getLastSegment(int addr) {
      ...
      jcas.throwFeatMissing("lastSegment", "type.SourceDocumentInformation");
  ...
  public int getDocumentSize(int addr) {
      ...
      jcas.throwFeatMissing("documentSize", "type.SourceDocumentInformation");
